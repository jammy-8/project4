...
![Front](booking/READM-ME-IMG/hero.png)
...
![Heading](booking/READM-ME-IMG/hero.png)
...
- HTML
  ...
  - Base
  ![Heading](booking/READM-ME-IMG/base_html_validator.png)

  - Navigation bar
  ![Heading](booking/READM-ME-IMG/navbar_html_validator.png)

  - Index
  ![Heading](booking/READM-ME-IMG/index_html_validator.png)

  - Booking
   ![Heading](booking/READM-ME-IMG/booking_html_success.png)

  - Booking Success
  ![Heading](booking/READM-ME-IMG/booking_success_html_validator.png)

- CSS
  - No errors were returned when passing through the official [(Jigsaw)_validator]
  ![Heading](booking/READM-ME-IMG/css_validator.png)
